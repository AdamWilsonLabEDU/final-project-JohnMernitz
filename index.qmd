...
Interesting analyses from count and total ecological benefits alone. Although higher in overall count, crabapple and planetree are not in the highest ecological benefit categories. That section is dominated by maple species. Assuming everyone who has a vacant slot plants a tree (distributed from top 15), by the time they reach maturity another $7,609,962 of ecological benefits could come from those 60,000 trees every year. It would be interesting to continue this analysis for tree canopy and localized temperature data.
